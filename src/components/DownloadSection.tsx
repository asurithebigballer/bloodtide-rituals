  ...
  return (
    <section ref={ref} className="relative py-40 px-4 bg-obsidian overflow-hidden">
      ...
      <motion.div className="absolute inset-0 flex items-center justify-center opacity-20">
        <motion.div className="absolute w-[600px] h-[600px] border-2 border-blood rounded-full" style={{ rotate: rotateOuter }} />
        <motion.div className="absolute w-[500px] h-[500px] border border-blood rounded-full" style={{ rotate: rotateInner }} />
        <motion.div className="absolute w-[400px] h-[400px] border border-blood/50 rounded-full" style={{ rotate: rotateOuter }} />
      </motion.div>
      ...
      <div className="relative z-10 max-w-3xl mx-auto text-center">
        ...
        {/* 🔥 BUTTON + REQUIREMENT (STACKED & CENTERED) */}
        <motion.div
